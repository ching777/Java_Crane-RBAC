            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" action="answer/clazz/add" id="clazzAddForm" method="post">
                            <div class="form-group">
                                    <label class="col-sm-3 control-label">班级名称：</label>
                                    <div class="col-sm-8">
                                        <input id="class_name" name="class_name"  type="text" class="form-control" minlength="2" required>
                           ...
                           <div class="form-group">
                            <label class="col-sm-3 control-label">班级性质</label>
                                <div class="col-sm-8">
                                    <select class="form-control m-b" name="class_property" id="class_property" required>
