...
<link href="resource/admin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow: hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span>
                                 <c:if test="${!empty session_user.userDetail.photo}"> 
                                    <img alt="图片展示" width="64" height="64" class="img-circle" src="attr/${session_user.userDetail.photo }">
                                </c:if>
                                <c:if test="${ empty session_user.userDetail.photo }"> 
                                    <img alt="图片展示" class="img-circle" src="attr/timg.jpg">
                                </c:if>
                            </span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li>
                                    <a class="J_menuItem" href="sys/user/update/photo">修改头像</a>
                                </li>
                                <li>
                                    <a href="sys/user/userDetailUpdate" class="J_menuItem" >个人资料</a>
                                </li>
                                <li>
                                ...
                                <li class="divider"></li>
                                <li>
                                    <a href="javascript:;" name="loginOut">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <!-- <li>
                         ...
                         <i class="fa fa-home"></i>
                             <span class="nav-label">答辩管理</span> <span class="fa arrow"></span>
                         </a>
                       <ul class="nav nav-second-level">
                         <li>
                             <a class="J_menuItem" href="answer/clazz/list" data-index="0">班级管理</a>
                             <a class="J_menuItem" href="answer/student/list" data-index="0">学生管理</a>
                             <a class="J_menuItem" href="answer/evaluate/evaluateList" data-index="0">评价备忘录</a>
                             <a class="J_menuItem" href="answer/time" data-index="0">答辩时间管理</a>
                             <a class="J_menuItem" href="answer/score/scoreList" data-index="0">答辩成绩管理</a>
                             <a class="J_menuItem" href="answer/work/main" data-index="0">优秀学生作品</a>
                         </li>
                       </ul>
                    </li> -->
                    <c:forEach items="${parentList }" var="parent">
                        <li>
                            <a href="javascript:;"> 
                                <c:if test="${empty parent.icon }" var="flag">
                                    <i class="fa fa-home"></i>
                                </c:if> 
                                <c:if test="${!flag }">
                            ...
                            <ul class="nav nav-second-level">
                                <c:forEach items="${childList}" var="child">
                                    <c:if test="${child.parent_id eq parent.resource_id }">
                                        <li>
                                            <a class="J_menuItem" href="${child.url }" data-index="0"><c:out value="${child.resource_name }"></c:out></a>
                                        </li>
                                    </c:if>
                                </c:forEach>
                            </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left"> <img alt="image" class="img-circle" src="resource/admin/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left"> <img alt="image" class="img-circle" src="resource/admin/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
            ...
            <div class="row content-tabs">
                ...
                <a href="JavaScript:;" class="roll-nav roll-right J_tabExit" name="loginOut"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
        ...
        <div id="right-sidebar">
            <div class="sidebar-container">
                <ul class="nav nav-tabs navs-3">
                    <li class="active">
                        <a data-toggle="tab" href="#tab-1"> <i class="fa fa-gear"></i> 主题
                        </a>
                    </li>
                    <li class="">
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="resource/admin/img/a1.jpg">
                                        <div class="m-t-xs">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="resource/admin/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="resource/admin/img/a4.jpg">
                                    </div>
                                    <div class="media-body">
                                        国外极限小子的炼成！这还是亲生的吗！！
                                        <br>
        ...
        <div id="small-chat">
            ...
            <a class="open-small-chat"> <i class="fa fa-comments"></i>
            </a>
        </div>
        <!--mini聊天窗口结束-->
    </div>
    ...
    <script src="resource/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="resource/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="resource/admin/js/plugins/layer/layer.min.js"></script>
    <!-- 自定义js -->
    <script src="resource/admin/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="resource/admin/js/contabs.js"></script>
    <script type="text/javascript" src="resource/page/login.js"></script>
    <script type="text/javascript">
					login_js.loginOut();
				</script>
    <!-- 第三方插件 -->
    <script src="resource/admin/js/plugins/pace/pace.min.js"></script>
</body>
</html>
