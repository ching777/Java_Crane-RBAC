            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" action="sys/group/add" id="groupAddFrom" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">组名称：</label>
                                <div class="col-sm-8">
                                    <input id="group_name" name="group_name" minlength="2" type="text" class="form-control">
                                    <span style="color:red;" id="error_group_name"></span>
                                </div>
                            </div>
                            <div class="form-group">
